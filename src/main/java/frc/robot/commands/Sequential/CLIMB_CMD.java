...
public class CLIMB_CMD extends SequentialCommandGroup {
  ...
  public CLIMB_CMD(ElevatorSubsystem elevatorSubsystem, EndEffectorSubsystem endEffectorSubsystem, CoralGroundIntakeSubsystem coralGroundIntakeSubsystem) {
    ...
    new ParallelCommandGroup(
                 ...
                 new GroundIntake_Setpoint_CMD(m_coralGroundIntakeSubsystem, SetpointConstants.kCoralIntakeSetpoint)));
  }
}
