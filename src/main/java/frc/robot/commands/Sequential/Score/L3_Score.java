...
public class L3_Score extends SequentialCommandGroup {
  ...
  public L3_Score(ElevatorSubsystem elevatorSubsystem, EndEffectorSubsystem endEffectorSubsystem) {
    ...
    new ParallelCommandGroup(
                 new Elevator_Setpoint_CMD(m_elevatorSubsystem, 12.23), 
                 new EndEffector_Setpoint_CMD(m_endEffectorSubsystem, 0.162)));
  }
}
