...
package frc.robot.commands.Sequential.Score;
...
public class L2_Score extends SequentialCommandGroup {
  ...
  public L2_Score(ElevatorSubsystem elevatorSubsystem, EndEffectorSubsystem endEffectorSubsystem) {
    ...
    new ParallelCommandGroup(
                 new Elevator_Setpoint_CMD(m_elevatorSubsystem, 7.3),//7.25
                 new EndEffector_Setpoint_CMD(m_endEffectorSubsystem, 0.17)));//0.148
  }
}
